...
3. 「一覧に保存」で案件を保存（端末のlocalStorageに保存。サーバーに送信しない）
...
東京法務局・大阪法務局・鹿児島地方法務局の完了予定日ページから、
`法務局 → 登記種別 → 庁 → 申請日 → 完了予定日` を `app/data/` へ書き出す。

- 東京：HTMLの完了予定日ページ群を取得
- 大阪：HTMLの完了予定日一覧を取得
- 鹿児島：PDFの完了予定日表を取得して文字抽出
